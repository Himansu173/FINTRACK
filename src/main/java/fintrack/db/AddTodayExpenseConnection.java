...
public class AddTodayExpenseConnection {
    public AddTodayExpenseConnection(String email, String date, int amount, String time, String category, String description)
            throws Exception {
