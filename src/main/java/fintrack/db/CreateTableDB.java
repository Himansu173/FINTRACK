...
public class CreateTableDB {
    ...
    public CreateTableDB() throws Exception {
        ...
        if (!resultSet.next()) { // Table does not exist
            ...
            String createFutureExpenseTableString = "CREATE TABLE FUTURE_EXPENSE(EMAIL VARCHAR2(100),EXPENSE_DATE VARCHAR(10), AMOUNT NUMBER(20), CATEGORY VARCHAR2(30), PRIMARY KEY(EMAIL,EXPENSE_DATE,CATEGORY,AMOUNT), CONSTRAINT fk_future_expense_email FOREIGN KEY (EMAIL) REFERENCES USERS(EMAIL))";
